...
%global common_desc \
This is a client for the OpenStack Karbor API. It provides a Python \
API (the karborclient module) and a command-line interface (Karbor).
...
This package contains auto-generated documentation for karbor client.
...
ln -s %{_bindir}/%{executable}-%{python3_version} %{buildroot}%{_bindir}/%{executable}-3
%endif
