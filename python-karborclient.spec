...
Requires:       python-babel != 2.4.0, >= 2.3.4
Requires:       python-prettytable < 0.8, >= 0.7.1
Requires:       python-keystoneauth1 >= 3.1.0
Requires:       python-osc-lib >= 1.7.0
Requires:       python-oslo-i18n != 3.15.2, >= 2.1.0
Requires:       python-oslo-log >= 3.22.0
Requires:       python-oslo-utils >= 3.20.0
Requires:       python-pbr != 2.1.0, >= 2.0.0
...
Requires:       python3-babel != 2.4.0, >= 2.3.4
Requires:       python3-prettytable < 0.8, >= 0.7.1
Requires:       python3-keystoneauth1 >= 3.1.0
Requires:       python3-osc-lib >= 1.7.0
Requires:       python3-oslo-i18n != 3.15.2, >= 2.1.0
Requires:       python3-oslo-log >= 3.22.0
Requires:       python3-oslo-utils >= 3.20.0
Requires:       python3-pbr != 2.1.0, >= 2.0.0
